...
func (c *userClient) Create(ctx context.Context, in *CreateReq, opts ...grpc.CallOption) (*GetUserResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserResp)
...
type UserServer interface {
	...
	Create(context.Context, *CreateReq) (*GetUserResp, error)
...
func (UnimplementedUserServer) Create(context.Context, *CreateReq) (*GetUserResp, error) {
